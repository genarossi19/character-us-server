...
import { submitWord, castVote, sendChatMessage } from "../services/game.service.ts";
    ...
    try {
      ...
      if (!result.success) {
        const codeMap: Record<string, string> = {
          ...
          "Jugador eliminado no puede submitir": "PLAYER_NOT_ALIVE",
      ...
      ack({
        success: false,
        message: "Error al enviar palabra",
        code: "INTERNAL_ERROR",
      });
    }
  });
